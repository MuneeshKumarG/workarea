...
public partial class Page3 : ContentPage
{
    ...
    public Page3()
	{
        ...
        barPointer.AnimationCompleted += BarPointer_AnimationCompleted;
    }

    private void BarPointer_AnimationCompleted(object sender, Syncfusion.Maui.Gauges.ValueChangedEventArgs e)
    {
        ...
        //contentPointer.Content=new Label() { Text = "Dynamic" };
    }
    ...
    {
        pointer.Alignment = gaugeAlignment;
    }

    private void BarPositionVAlignmentStart_Clicked(object sender, EventArgs e)
    {
        UpdateVerticalAlignment(shapePointer, GaugeElementPosition.Outside);
    }

    private void BarPositionVAlignmentCenter_Clicked(object sender, EventArgs e)
    {
        UpdateVerticalAlignment(shapePointer, GaugeElementPosition.Cross);
    }

    private void BarPositionVAlignmentEnd_Clicked(object sender, EventArgs e)
    {
        UpdateVerticalAlignment(shapePointer, GaugeElementPosition.Inside);
    }

    private void UpdateVerticalAlignment(LinearMarkerPointer pointer, GaugeElementPosition gaugeAlignment)
    {
        pointer.Position = gaugeAlignment;
    }
    ...
    {
        UpdateVerticalAlignment(contentPointer, GaugeElementPosition.Outside);
    }

    private void ContentPositionVAlignmentCenter_Clicked(object sender, EventArgs e)
    {
        UpdateVerticalAlignment(contentPointer, GaugeElementPosition.Cross);
    }

    private void ContentPositionVAlignmentEnd_Clicked(object sender, EventArgs e)
    {
        UpdateVerticalAlignment(contentPointer, GaugeElementPosition.Inside);
    }
