...
{
    /// <summary>
    /// Renders the circular type charts.
    /// </summary>
    /// <remarks>
    ...
    ///    
    ///        <chart:SfCircularChart.Series>
    ///            <chart:DoughnutSeries ShowDataLabels = "True" ItemsSource="{Binding Data}" XBindingPath="XValue" YBindingPath="YValue"/>
    ///        </chart:SfCircularChart.Series>
    /// </chart:SfCircularChart>
    ///
    /// ]]>
    ...
    public class SfCircularChart : ChartBase, ITouchListener, ITapGestureListener
    {
        ...
        /// <summary>
        /// Gets or sets a collection of chart series to be added in the circular chart.
        /// </summary>
