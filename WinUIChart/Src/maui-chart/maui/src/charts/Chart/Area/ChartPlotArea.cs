...
namespace Syncfusion.Maui.Charts
{
    internal class ChartPlotArea : AbsoluteLayout, IPlotArea
    {
        ...
        void ToggleLegendItem(ILegendItem legendItem)
        {
            ...
            {
                var cartesianLegendItem = legendItem as CartesianLegendItem;

                if (cartesianLegendItem != null && cartesianLegendItem.Series != null)
                {
                    ...
                    cartesianLegendItem.Series.IsVisible = !legendItem.IsToggled;
                }
            }
        }
