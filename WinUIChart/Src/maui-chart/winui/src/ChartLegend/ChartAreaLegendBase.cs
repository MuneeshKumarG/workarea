...
namespace Syncfusion.UI.Xaml.Charts
{
    public partial class ChartBase
    {
        ...
        internal void SetLegendItemsSource(ChartLegend legend, int index)
        {
            ...
            else if (VisibleSeries.Count == 1 && ActualSeries.Count == 1 && VisibleSeries[0] is WaterfallSeries)
            {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private void SetWaterfallLegendItems(ChartLegend legend, int index)
        {
            ...
            {
                legendItem = GetWaterfallLegendItem(positiveSegment, ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("Increase"), 0, legend);
                LegendItems[index].Add(legendItem);
            }
            ...
            {
                legendItem = GetWaterfallLegendItem(negativeSegment, ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("Decrease"), 1, legend);
                LegendItems[index].Add(legendItem);
            }
            ...
            if (sumSegment != null)
            {
                legendItem = GetWaterfallLegendItem(sumSegment, ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("Total"), 2, legend);
                LegendItems[index].Add(legendItem);
            }
        }
