...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class TechnicalIndicatorSegment : FastLineSegment
    {
        #region constructor

        /// <summary>
        /// Called when instance created for <see cref="TechnicalIndicatorSegment"/>.
        /// </summary>
        ...
        internal void SetValues(List<double> xVals, List<double> yVals, Brush stroke, ChartSeriesBase series)
        {
            ...
            (Series as ChartSeries).Stroke = stroke;
