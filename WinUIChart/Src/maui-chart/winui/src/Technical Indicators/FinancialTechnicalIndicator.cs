...
{
    /// <summary>
    /// Base class for all the Financial technical indicators available in <see cref="ChartBase"/> control.
    /// </summary>
    ...
    internal abstract class FinancialTechnicalIndicator : ChartSeries, ISupportAxes2D
    {
        /// <summary>
