...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class MACDTechnicalIndicator : FinancialTechnicalIndicator
    {
        #region ctor

        /// <summary>
        /// Called when instance created for <see cref="MACDTechnicalIndicator"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates the segments of <see cref="MACDTechnicalIndicator"/>.
        /// </summary>
