...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class DateTimeAxis : RangeAxisBase
    {
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register(nameof(Minimum), typeof(object), typeof(DateTimeAxis), new PropertyMetadata(null, OnMinimumChanged));

        /// <summary>
        /// The DependencyProperty for <see cref="Maximum"/> property.
        /// </summary>
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register(nameof(Maximum), typeof(object), typeof(DateTimeAxis), new PropertyMetadata(null, OnMaximumChanged));
        ...
        private double ValueToBusinesshoursCoefficient(double value)
        {
            ...
            return IsActualInversed ? 1d - result : result;
        }
