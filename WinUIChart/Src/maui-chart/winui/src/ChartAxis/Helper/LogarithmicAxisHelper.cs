...
namespace Syncfusion.UI.Xaml.Charts
{
    internal static class LogarithmicAxisHelper
    {
        ...
        /// <param name="logBase">Used to indicate <see cref="LogarithmicAxis.LogarithmicBase"/></param>
        ...
        internal static void OnMinMaxChanged(ChartAxis axis, object minimum, object maximum, double logarithmicBase)
        {
            if (minimum != null || maximum != null)
            {
                ...
                double maximumValue = maximum == null ? double.PositiveInfinity : ((double?)maximum > 0 ? (double?)maximum : 1).Value;
