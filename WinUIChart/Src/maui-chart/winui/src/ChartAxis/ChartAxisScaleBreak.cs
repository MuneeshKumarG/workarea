...
using DataBinding = Microsoft.UI.Xaml.Data;
...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// </remarks>
    internal class ChartAxisScaleBreak : FrameworkElement, INotifyPropertyChanged
    {
...
#region Constructor
        ...
        internal static void DrawPath(NumericalAxis axis)
        {
            ...
            var plotOffset = axis.GetActualPlotOffsetEnd();
        ...
        private static DataBinding.Binding CreateBinding(string path, object source)
        {
            var bindingProvider = new DataBinding.Binding
            {
                Path = new PropertyPath(path),
                Source = source,
                Mode = DataBinding.BindingMode.OneWay
            };
