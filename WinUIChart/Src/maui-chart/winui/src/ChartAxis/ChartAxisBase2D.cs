...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public abstract class ChartAxisBase2D : ChartAxis
    {
        ...
        /// <summary>
        /// The Dependency property of <see cref="PolarAngle"/> property
        /// </summary>
        public static readonly DependencyProperty PolarAngleProperty =
            DependencyProperty.Register(
                ...
                typeof(ChartAxisBase2D), 
                new PropertyMetadata(ChartPolarAngle.Rotate270, OnAxisPropertyChanged));

        /// <summary>
        /// The DependencyProperty for <see cref="LabelBorderBrush"/> property 
        /// </summary>
        internal static readonly DependencyProperty LabelBorderBrushProperty =
            DependencyProperty.Register(nameof(LabelBorderBrush), typeof(Brush), typeof(ChartAxisBase2D), new PropertyMetadata(null));

        /// <summary>
        /// The Dependency property <see cref="ShowLabelBorder"/>
        /// </summary>
        internal static readonly DependencyProperty ShowLabelBorderProperty =
            DependencyProperty.Register(nameof(ShowLabelBorder), typeof(bool), typeof(ChartAxisBase2D), new PropertyMetadata(false, OnAxisPropertyChanged));

        /// <summary>
        /// The DependencyProperty for <see cref="LabelBorderWidth"/> property 
        /// </summary>
        internal static readonly DependencyProperty LabelBorderWidthProperty =
            DependencyProperty.Register(
                nameof(LabelBorderWidth),
                typeof(double),
                typeof(ChartAxisBase2D),
        ...
        /// </summary>
        internal static readonly DependencyProperty IncludeStripLineRangeProperty =
            DependencyProperty.Register(
                nameof(IncludeStripLineRange), 
                typeof(bool), 
                typeof(ChartAxisBase2D),
        ...
        /// </summary>
        internal static readonly DependencyProperty StripLinesProperty =
            DependencyProperty.Register(
                nameof(StripLines),
        ...
        /// </summary>
        internal static readonly DependencyProperty MultiLevelLabelsProperty =
            DependencyProperty.Register(nameof(MultiLevelLabels), typeof(ChartMultiLevelLabels), typeof(ChartAxisBase2D), new PropertyMetadata(null, OnMultiLevelLabelsChanged));

        /// <summary>
        /// The Dependency Property for <see cref="MultiLevelLabelsBorderType"/>
        /// </summary>
        internal static readonly DependencyProperty MultiLevelLabelsBorderTypeProperty =
            DependencyProperty.Register(nameof(MultiLevelLabelsBorderType), typeof(BorderType), typeof(ChartAxisBase2D), new PropertyMetadata(BorderType.Rectangle, OnAxisPropertyChanged));

        /// <summary>
        ///  The DependencyProperty for <see cref="EnableScrollBarResizing"/> property.
        /// </summary>
        internal static readonly DependencyProperty EnableScrollBarResizingProperty =
            DependencyProperty.Register(
                nameof(EnableScrollBarResizing), 
                typeof(bool),
                typeof(ChartAxis),
        ...
        /// </summary>
        internal static readonly DependencyProperty EnableScrollBarProperty =
            DependencyProperty.Register(
                nameof(EnableScrollBar),
                typeof(bool),
                typeof(ChartAxis),
        ...
        /// </summary>
        internal static readonly DependencyProperty DeferredScrollingProperty =
            DependencyProperty.Register(
                nameof(DeferredScrolling), 
                typeof(bool),
                typeof(ChartAxis),
        ...
        /// </summary>
        internal static readonly DependencyProperty EnableTouchModeProperty =
            DependencyProperty.Register(
                nameof(EnableTouchMode),
                typeof(bool),
                typeof(ChartAxis),
...
#region Public Properties
        ...
        /// </summary>
        internal Brush LabelBorderBrush
        {
        ...
        /// </summary>
        internal ChartMultiLevelLabels MultiLevelLabels
        {
        ...
        /// </summary>
        internal BorderType MultiLevelLabelsBorderType
        {
        ...
        /// </remarks>
        internal bool IncludeStripLineRange
        {
        ...
        /// </summary>
        internal ChartStripLines StripLines
        {
        ...
        /// </summary>
        internal bool EnableScrollBarResizing
        {
        ...
        /// </summary>
        internal bool DeferredScrolling
        {
        ...
        /// </summary>
        internal double LabelBorderWidth
        {
...
#region Public Override Methods
        ...
        internal override double PolarCoefficientToValue(double value)
        {
            double result = double.NaN;
...
#region Internal Override Methods
        ...
        {
            if (this.Area != null && (Area as ChartBase).GridLinesPanel != null)
            {
                GridLinesRecycler = new UIElementsRecycler<Line>((Area as ChartBase).GridLinesPanel);
                MinorGridLinesRecycler = new UIElementsRecycler<Line>((Area as ChartBase).GridLinesPanel);
            }
        }
        ...
        internal void SetLabelDownArguments(object source)
        {
            ...
            if (element != null)
            {
                ...
                if (parent != null)
                {
                    ...
                    args.Label = parent.Tag as ChartAxisLabel;
        ...
        {
            {
                ...
                multiLevelLabelsPanel = this.GetTemplateChild("SyncfusionChartAxisMultiLevelLabelsPanels") as Panel;
...
#region Private Static Methods
        ...
        private static void OnZoomFactorChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (axis.Area != null && (axis.Area as ChartBase).zoomingToolBar != null)
        ...
        private static void OnIncludeStripLineRangeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (axis != null && axis.Area != null)
                (axis.Area as ChartBase).UpdateStripLines();
        }
...
#region Private Methods
        ...
        private void EnableZoomingToolBarState()
        {
            if (this.ZoomPosition > 0 || this.ZoomFactor < 1)
                (this.Area as ChartBase).ChangeToolBarState();
            else
                (this.Area as ChartBase).ResetToolBarState();
        }
        ...
        {
            if (Area != null)
                (Area as ChartBase).UpdateStripLines();
#if !WinUI_Desktop
        ...
        private void OnStripLinesPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            {
                DispatcherQueue.TryEnqueue(() => { UpdateStripsLines(); });
