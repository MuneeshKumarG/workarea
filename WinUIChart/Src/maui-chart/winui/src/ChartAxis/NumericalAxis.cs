...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class NumericalAxis : RangeAxisBase
    {
        ...
        /// </summary>
        internal static readonly DependencyProperty AxisScaleBreaksProperty =
            DependencyProperty.Register(nameof(AxisScaleBreaks), typeof(ChartAxisScaleBreaks), typeof(NumericalAxis), new PropertyMetadata(null, OnScaleBreakChanged));

        /// <summary>
        /// The DependencyProperty for <see cref="BreakPosition"/> property.
        /// </summary>
        internal static readonly DependencyProperty BreakPositionProperty =
            DependencyProperty.Register(
                nameof(BreakPosition), 
        ...
        /// <summary>
        /// Called when instance created for <see cref="NumericalAxis"/>.
        /// </summary>
        ...
        /// </summary>
        internal ChartAxisScaleBreaks AxisScaleBreaks
        {
        ...
        /// </value>
        internal ScaleBreakPosition BreakPosition
        {
        ...
        internal NumericalPadding ActualRangePadding
        {
            get
            {
                ChartBase sfArea = Area as ChartBase;
                var seriesCollection = sfArea != null? sfArea.GetSeriesCollection() :null;
                if (RangePadding == NumericalPadding.Auto && seriesCollection != null && seriesCollection.Count > 0)
                {
                    if ((Orientation == Orientation.Vertical && !(seriesCollection[0] as ChartSeries).IsActualTransposed) ||
                        (Orientation == Orientation.Horizontal && (seriesCollection[0] as ChartSeries).IsActualTransposed))
...
#region Public Override Methods
        ...
        internal override double CoefficientToValue(double value)
        {
        ...
        internal override double ValueToCoefficient(double value)
        {
            double result = double.NaN;
...
#region Protected Override Methods
        ...
        protected override void GenerateVisibleLabels()
        {
            ...
            ClearBreakElements();
            if (AxisScaleBreaks.Count > 0 && this.IsSecondaryAxis && CustomLabels.Count == 0 && GetLabelSource() == null)
            {
                ComputeScaleBreaks();
            }
            else
        ...
        protected override DoubleRange CalculateActualRange()
        {
            if (ActualRange.IsEmpty) // Executes when Minimum and Maximum aren't set.
            {
                ...
                {
                    foreach (var annotation in (Area as ChartBase).Annotations)
                    {
