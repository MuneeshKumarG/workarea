...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class CategoryAxis : ChartAxisBase2D
    {
        ...
        public static readonly DependencyProperty IsIndexedProperty =
            DependencyProperty.Register(nameof(IsIndexed), typeof(bool), typeof(CategoryAxis), new PropertyMetadata(true, OnIntervalChanged));

        /// <summary>
        /// The DependencyProperty for <see cref="AggregateFunctions"/> property.
        /// </summary>
        internal static readonly DependencyProperty AggregateFunctionsProperty =
            DependencyProperty.Register(nameof(AggregateFunctions), typeof(AggregateFunctions), typeof(CategoryAxis), new PropertyMetadata(AggregateFunctions.None, OnIntervalChanged));
        ...
        /// </summary>
        internal AggregateFunctions AggregateFunctions
        {
