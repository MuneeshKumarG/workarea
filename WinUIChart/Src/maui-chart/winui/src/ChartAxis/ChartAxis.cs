...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// reference to any x-axis,y-axis added to <see cref="ChartBase"/>
    /// </remarks>
    /// <example>
    /// <code language="XAML">
    ///     &lt;syncfusion:SfChart&gt;
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1721: Property names should not match get methods")]
    ...
    public abstract class ChartAxis : Control
    {
        ...
        /// </summary>
        internal static readonly DependencyProperty HeaderPositionProperty =
            DependencyProperty.Register(
        ...
        /// </summary>
        internal static readonly DependencyProperty PositionPathProperty =
          DependencyProperty.Register(
              nameof(PositionPath),
              typeof(string),
              typeof(ChartAxis),
        ...
        /// <summary>
        ///The DependencyProperty for <see cref="LabelSource"/> property.
        /// </summary>
        ...
        /// </summary>
        internal static readonly DependencyProperty PostfixLabelTemplateProperty =
            DependencyProperty.Register(
                nameof(PostfixLabelTemplate),
                typeof(DataTemplate),
                typeof(ChartAxis),
        ...
        /// </summary>
        internal static readonly DependencyProperty PrefixLabelTemplateProperty =
            DependencyProperty.Register(
                nameof(PrefixLabelTemplate),
                typeof(DataTemplate),
                typeof(ChartAxis),
                new PropertyMetadata(null, new PropertyChangedCallback(OnLabelTemplateChanged)));

        /// <summary>
        /// The DependencyProperty for <see cref="LabelIntersectAction"/> property.
        /// </summary>
        public static readonly DependencyProperty LabelIntersectActionProperty =
            DependencyProperty.Register(
                nameof(LabelIntersectAction), 
                typeof(AxisLabelIntersectAction),
                typeof(ChartAxis), 
                new PropertyMetadata(AxisLabelIntersectAction.Hide, OnPropertyChanged));
        ...
        /// </summary>
        internal static readonly DependencyProperty OriginProperty =
            DependencyProperty.Register(
                nameof(Origin),
                typeof(double),
                typeof(ChartAxis),
        ...
        /// </summary>
        internal static readonly DependencyProperty ShowOriginProperty =
            DependencyProperty.Register(
                nameof(ShowOrigin),
                typeof(bool),
                typeof(ChartAxis),
        ...
        /// </summary>
        internal static readonly DependencyProperty ShowAxisNextToOriginProperty =
            DependencyProperty.Register(
                nameof(ShowAxisNextToOrigin),
                typeof(bool),
                typeof(ChartAxis),
        ...
        /// </summary>
        internal static readonly DependencyProperty OriginLineStyleProperty =
            DependencyProperty.Register(nameof(OriginLineStyle), typeof(Style), typeof(ChartAxis), null);
        ...
        public static readonly DependencyProperty MajorGridLineStyleProperty =
            DependencyProperty.Register(nameof(MajorGridLineStyle), typeof(Style), typeof(ChartAxis), null);
        ...
        public static readonly DependencyProperty MinorTickLineStyleProperty =
            DependencyProperty.Register(nameof(MinorTickLineStyle), typeof(Style), typeof(ChartAxis), null);
        ...
        internal static readonly DependencyProperty ActualTrackBallLabelTemplateProperty =
            DependencyProperty.Register(
                nameof(ActualTrackBallLabelTemplate), 
                typeof(DataTemplate),
                typeof(ChartAxis), 
                null);
        ...
        /// </summary>
        internal static readonly DependencyProperty RangeStylesProperty =
            DependencyProperty.Register(
                nameof(RangeStyles),
        ...
        internal double previousLabelCoefficientValue = -1;
...
#region Protected Fields
        ...
        /// </summary>
		internal const int CRoundDecimals = 11;
...
#region Private Fields
        ...
        private double actualPlotOffsetStart = 0;

        private double actualPlotOffsetEnd = 0;
...
#region Constructor
        ...
        public ChartAxis()
        {
            ...
            AxisLabelCoefficientRoundOffValue = 2;
			IsActualInversed = false;
		}
...
#region Public Properties
        ...
        /// </summary>
        internal AxisHeaderPosition HeaderPosition
        {
        ...
        public Rect ArrangeRect
        {
            ...
            internal set
            {
                ...
                if (Orientation.Equals(Orientation.Horizontal))
                {
                    ...
                    RenderedRect = new Rect(arrangeRect.Left + GetActualPlotOffsetStart(), arrangeRect.Top, width, arrangeRect.Height);
                }
                else
                {
                    double height = Math.Max(0, arrangeRect.Height - GetActualPlotOffset());
                    RenderedRect = new Rect(arrangeRect.Left, arrangeRect.Top + GetActualPlotOffsetEnd(), arrangeRect.Width, height);
                }
            }
        }
        ...
        /// </summary>
        /// <remarks>
        /// <see cref="ChartAxis.PlotOffsetStart"/> applies padding at start of plot area where the axis and its elements are rendered in chart with padding at start.
        /// <see cref="ChartAxis.PlotOffsetStart"/> is not applicable for polar and radar chart series.
        /// If the values set to both  <see cref="ChartAxis.PlotOffset"/> and <see cref="ChartAxis.PlotOffsetStart"/>,
        /// then <see cref="ChartAxis.PlotOffset"/> takes highest precedence.
        /// </remarks>
        /// <value>
        /// The default value is 0.
        /// </value>
        /// <seealso cref="ChartAxis.PlotOffset"/>
        /// <seealso cref="ChartAxis.PlotOffsetEnd"/>
        ...
        /// </summary>
        /// <remarks>
        /// <see cref="ChartAxis.PlotOffsetEnd"/> applies padding at end of plot area where the axis and its elements are rendered in chart with padding at end.
        /// <see cref="ChartAxis.PlotOffsetEnd"/> is not applicable for polar and radar chart series.
        /// If the values set to both  <see cref="ChartAxis.PlotOffset"/> and <see cref="ChartAxis.PlotOffsetEnd"/>,
        /// then <see cref="ChartAxis.PlotOffset"/> takes highest precedence.
        /// </remarks>
        /// <value>
        /// The default value is 0.
        /// </value>
        /// <seealso cref="ChartAxis.PlotOffset"/>
        /// <seealso cref="ChartAxis.PlotOffsetStart"/>
        ...
        /// </value>
        public AxisElementPosition LabelPosition
        {
            get { return (AxisElementPosition)GetValue(LabelPositionProperty); }
            set { SetValue(LabelPositionProperty, value); }
        }
        /// <summary>
        /// Gets or sets the custom labels collection to be displayed in axis .
        /// </summary>
        public object LabelSource
        {
            get { return (object)GetValue(LabelSourceProperty); }
        ...
        /// </value>
        internal DataTemplate PostfixLabelTemplate
        {
        ...
        /// <see cref="DataTemplate"/>
        /// </value>
        internal DataTemplate PrefixLabelTemplate
        {
        ...
        /// </summary>
        /// <value>
        /// <see cref="Syncfusion.UI.Xaml.Charts.AxisLabelIntersectAction"/>
        /// </value>
        public AxisLabelIntersectAction LabelIntersectAction
        {
            get { return (AxisLabelIntersectAction)GetValue(LabelIntersectActionProperty); }
            set { SetValue(LabelIntersectActionProperty, value); }
        }
        ...
        /// </summary>
        internal bool ShowAxisNextToOrigin
        {
        ...
        /// </summary>
        internal Style OriginLineStyle
        {
...
#region Internal Properties
        ...
        {
            get { return actualPlotOffsetStart; }
            set { actualPlotOffsetStart = value; }
        }
        ...
        {
            get { return actualPlotOffsetEnd; }
            set { actualPlotOffsetEnd = value; }
        }
        ...
        internal ChartBase Area
        {
            ...
            {
                area = value;
                if(this is ChartAxisBase2D && area is SfPolarChart)
                {
                    (this as ChartAxisBase2D).PolarAngle = (area as SfPolarChart).StartAngle;
                }
            }
        }
...
#region Public Virtual Methods
        ...
        /// <seealso cref="ValueToCoefficient(double)"/>
        internal virtual double CoefficientToValue(double value)
        {
        ...
        /// <param name="value">The absolute point value.</param>
        /// <returns>The value of point on axis.</returns>
        internal virtual double CoefficientToActualValue(double value)
        {
            double result = double.NaN;
       ...
       internal virtual double ValueToCoefficient(double value)
        {
            double result = double.NaN;
            ...
            return this.IsActualInversed ? 1d - result : result;
        }
        ...
        internal virtual double ValueToPolarCoefficient(double value)
        {
            ...
            return this.IsActualInversed ? result : 1d - result;
        }
        ...
        /// <seealso cref="ChartAxis.CoefficientToValueCalc"/>  
        internal virtual double ValueToCoefficient(double value, bool isInversed)
        {
            double result = double.NaN;
        ...
        {
            if ((CustomLabels.Count > 0 || GetLabelSource() != null))
            {
...
#region Internal Methods
        ...
        internal object GetCustomLabelContent(double position)
        {
            ...
            foreach (var label in VisibleLabels)
            {
                ...
                {
                    customLabelContent = label.GetContent().ToString();
                }
            }
        ...
        internal AxisElementPosition GetLabelPosition()
        {
            return this.LabelPosition;
        }

        internal object GetLabelSource()
        {
            return this.LabelSource;
        }

        internal AxisLabelIntersectAction GetLabelIntersection()
        {
            return this.LabelIntersectAction;
        }
#endregion
...
#region Protected Internal Virtual Methods
        ...
        /// </summary>
        /// <param name="args">Which indicates <see cref="ChartAxisBoundsEventArgs"/></param>
        ...
        /// <summary>
        /// Event invokes when axis <see cref="VisibleRange"/> is changed.
        /// </summary>
        /// <param name="args">Which indicates <see cref="VisibleRangeChangedEventArgs"/></param>
...
#region Protected Virtual Methods
        ...
        /// <summary>
        /// Event correspond to property value changed. It invokes when the <see cref="ChartAxis"/> properties changed.
        /// </summary>
        ...
        protected virtual DoubleRange CalculateActualRange()
        {
            if (Area != null)
            {
                ...
                if (Area is ChartBase && (Area as ChartBase).TechnicalIndicators != null)
                {
                    foreach (ChartSeries indicator in (Area as ChartBase).TechnicalIndicators)
                    {
                        technicalIndicators.Add(indicator as ChartSeriesBase);
                    }
                }

                var seriesRange = (Area is ChartBase ? Area.VisibleSeries.Union(technicalIndicators).OfType<ISupportAxes>() :
        ...
        protected virtual void OnRegisteredSeriesCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            else if (e.Action == NotifyCollectionChangedAction.Remove)
            {
                ...
                if (Area != null && xAxis != null && yAxis != null && xAxis.associatedAxes != null && yAxis.associatedAxes != null)
                {
                    ...
                    {
                        if (!Area.InternalAxes.Contains(yAxis))
                            xAxis.associatedAxes.Remove(yAxis);
                        if (!Area.InternalAxes.Contains(xAxis))
            ...
            else if (e.Action == NotifyCollectionChangedAction.Reset)
            {
                ...
                if (Area != null)
                {
                    if (Area is ChartBase)
                    {
                        var seriesCollection = (Area as ChartBase).GetSeriesCollection();
                        ObservableCollection<ChartSeries> technicalIndicatorCollection = (Area as ChartBase).TechnicalIndicators;
...
#region Private Methods
        ...
        {
            IsActualInversed = this.IsInversed;
            if (this.Area != null)
            {
                this.Area.ScheduleUpdate();
            }
        ...
        private void PopulateVisibleLabelsForLabelSource()
        {
            ...
            if (!(this.GetLabelSource() is Windows.Data.Xml.Dom.XmlElement))
            {
                labelsSource = this.GetLabelSource();
            }
            else
            {
                IList source = new List<IXmlNode>();
                CreateXmlSourceListWrapper((this.GetLabelSource() as Windows.Data.Xml.Dom.XmlElement), ref source);
                labelsSource = source;
            }
        ...
        void m_VisibleLabels_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.Action == NotifyCollectionChangedAction.Add)
            {
                ...
                var currentLabelCoeffientValue = ValueToCoefficientCalc(item.Position);

                //Checking the position of the current label already has a label or not.
                //WPF - 53249 Performance lags and chart freezes when setting a small axis interval with a live chart. So round the coefficient value with 2 digits.
                if (double.Equals(Math.Round(previousLabelCoefficientValue, AxisLabelCoefficientRoundOffValue), Math.Round(currentLabelCoeffientValue, AxisLabelCoefficientRoundOffValue)))
                {
        ...
        private void CheckAxes(ChartAxis chartAxis)
        {
            if (Area != null)
            {
                ...
                {
                    if (!Area.InternalAxes.Contains(axis))
...
#if WinUI_Desktop
                    DispatcherQueue.TryEnqueue(() => { CheckRegisterSeries(); });
#else
        ...
        private void CheckRegisterSeries()
        {
            foreach (ChartSeriesBase chartSeries in RegisteredSeries)
            {
                ...
                {
                    throw new InvalidOperationException(RegisteredSeries[0].GetType() + " " + ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("AxisIncompatibleExceptionMessage") + " " + chartSeries.GetType());
                }
            }
