...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class DateTimeCategoryAxis : ChartAxisBase2D
    {
...
#region Protected Override Methods
        ...
        protected override void GenerateVisibleLabels()
        {
            ...
            actualSeries = actualSeries != null ? actualSeries : Area is ChartBase ? (Area as ChartBase).TechnicalIndicators.Where(series => series.ActualXAxis == this)
