        ...
        internal static ResourceDictionary GenericLegendDictionary
        {
            ...
            get
            {
                if (genericLegendDictionary == null)
                {
                    ...
                    {
                        Source = new Uri(@"ms-appx:///Syncfusion.Chart.WinUI/ChartSeries/Themes/Generic.Legend.xaml")
                    };
        ...
        internal static ResourceDictionary GenericCommonDictionary
        {
            get
            {
                if(genericCommonDictionary == null)
                {
                    ...
                    {
                        Source = new Uri(@"ms-appx:///Syncfusion.Chart.WinUI/ChartSeries/Themes/TrackballAndDragging.xaml")
                    };

                    genericCommonDictionary.MergedDictionaries.Add(dictionary);
                }
