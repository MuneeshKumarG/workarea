...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal static partial class WriteableBitmapExtensions
    {
        ...
        /// <param name="y2"></param>
        /// <returns></returns>
        internal static double Slope(double x1, double y1, double x2, double y2)
        {
            return ((y2 - y1) / (x2 - x1));
        }
        ...
        /// <returns></returns>
        internal static double Intersect(double x, double y, double slope)
        {
            return (y - slope * x);
        }
        ...
        /// Method implementation for clear values.
        /// </summary>
        /// <param name="bmp">Used to specifiy the <see cref="WriteableBitmap"/>.</param>
        /// <param name="stream">Used to specify the stream.</param>
        /// <param name="pixels">Used to specify the pixel.</param>
        ...
        /// </summary>
        /// <param name="bmp">Used to indicate <see cref="WriteableBitmap"/>.</param>
        /// <param name="buffer">Used to specify buffer for bitmap.</param>
        /// <param name="width">Used to specify the width.</param>
        /// <param name="height">Used to specify the height.</param>
        /// <param name="x1">Used to specify x1.</param>
        /// <param name="y1">Used to specify y1.</param>
        /// <param name="x2">Used to specify x2.</param>
        /// <param name="y2">Used to specify y2.</param>
        /// <param name="uiColor">Used to specify color for bitmap.</param>
        /// <param name="seriesPixels">Used to specify collection of pixels.</param>
        ...
        /// <param name="uiColor">Used to specify color for bitmap.</param>
        /// <param name="seriesPixels">Used to specify collection of pixels.</param>
        /// <param name="clip">USed to specify the series bound.</param>
        public static void DrawLineBresenham(this WriteableBitmap bmp, byte[] buffer,int width, 
       ...
       [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1801: Review unused parameters")]
        ...
        /// </summary>
        /// <param name="bmp">Used to indicate <see cref="WriteableBitmap"/>.</param>
        /// <param name="pixels">Used to specify buffer for bitmap.</param>
        /// <param name="pixelWidth">Used to specify the width.</param>
        /// <param name="pixelHeight">Used to specify the height.</param>
        /// <param name="x1">Used to specify x1.</param>
        /// <param name="y1">Used to specify y1.</param>
        /// <param name="x2">Used to specify x2.</param>
        /// <param name="y2">Used to specify y2.</param>
        ...
        /// <param name="uiColor">Used to specify color for bitmap.</param>
        /// <param name="seriesPixels">Used to specify collection of pixels.</param>
        /// <param name="clip">Used to specify the series bounds.</param>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1809:AvoidExcessiveLocals", Justification = "Reviewed")]
        public static void DrawLineAa(this WriteableBitmap bmp, byte[] pixels, int pixelWidth, int pixelHeight, int x1, int y1,
        ...
        /// <param name="buffer">Used to specify buffer value.</param>
        /// <param name="width">Used to specify the width.</param>
        /// <param name="height">Used to specify the height.</param>
        /// <param name="seriesPixels">Used to specify collection of pixels.</param>
        ...
        /// </summary>
        /// <param name="bmp">The WriteableBitmap.</param>
        /// <param name="xc">The x-coordinate of the bounding rectangle's left side.</param>
        /// <param name="yc">The y-coordinate of the bounding rectangle's top side.</param>
        /// <param name="xr">The x-coordinate of the bounding rectangle's right side.</param>
        /// <param name="yr">The y-coordinate of the bounding rectangle's bottom side.</param>
        /// <param name="color">The color.</param>
        /// <param name="buffer">Used to specify the buffer value.</param>
        /// <param name="width">Used to specify the width.</param>
        /// <param name="height">Used to specify the height.</param>
        /// <param name="seriesPixels">Used to specify collection of pixels.</param>
        ...
        /// <param name="xr">The x-coordinate of the bounding rectangle's right side.</param>
        /// <param name="yr">The y-coordinate of the bounding rectangle's bottom side.</param>
        /// <param name="pixels">Used to specify collection of pixels.</param>
        /// <returns>Returns the collection pixels.</returns>
        ...
        /// <param name="height">Used to specify the height.</param>
        /// <param name="seriesPixels">Used to specify collection of pixels.</param>
        /// <param name="buffer">Used to specify the collection of pixel buffer in byte.</param>
