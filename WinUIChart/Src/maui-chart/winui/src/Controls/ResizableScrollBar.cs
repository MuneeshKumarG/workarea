...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class ResizableScrollBar : ContentControl
    {
        ...
        private const double GapSize = 4, MinimumThumbSize = 0, ResizableBarSize = 15, MinimumDiff = 0;
    ...
    internal class RangeNavigatorSelector : ResizableScrollBar
    {
        #region Dependency Property Registration
