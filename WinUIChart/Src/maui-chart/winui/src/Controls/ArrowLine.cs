...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class ArrowLine : DependencyObject
    {
        ...
        WindowsLineSegment segmentLine;
...
#else
            return MatrixHelper.FromElements(m11, m12, m21, m22, 0, 0);
#endif
        }
...
#else
            matrix = MatrixHelper.FromElements(cosine, sine, -sine, cosine, 0, 0);
#endif
            matx = ArrowLine.MultiplyMatrixes(matx, matrix);
