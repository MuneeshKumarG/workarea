...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// </summary>
    internal abstract class ChartToolBarItem
    {
    }
    ...
    /// </summary>
    internal class ZoomingToolBarItem : ContentControl, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty ToolBarIconMarginProperty =
            DependencyProperty.Register(
                ...
                typeof(Thickness),
                typeof(ZoomingToolBarItem),
                new PropertyMetadata(new Thickness().GetThickness(0,0,0,0), OnSizeChanged));
#endregion
...
#region Internal Methods
        ...
        internal void Dispose()
        {
            ...
            if (PropertyChanged != null)
            {
                ...
                {
                    PropertyChanged -= handler as System.ComponentModel.PropertyChangedEventHandler;
                }
...
#region Private Methods
        ...
        {
#if WinUI_Desktop
            DispatcherQueue.TryEnqueue(() => { UpdateToolBarPosition(); });
#else
    ...
    /// </summary>
    internal class ZoomIn : ZoomingToolBarItem
    {
        #region Constructor
        ...
        public ZoomIn()
        {
            ...
            Tag = "ZoomIn";
            ToolTipService.SetToolTip(this, ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("ZoomIn"));
        }
...
#region Protected Methods
        ...
        protected override void OnPointerPressed(PointerRoutedEventArgs e)
        {
            ...
            {
                bool canZoom = false;
                foreach (ChartAxisBase2D axis in this.Source.ChartArea.InternalAxes)
                {
                    ...
                    {
                        if ((axis.Orientation.Equals(Orientation.Horizontal) && (Source.ZoomMode == ZoomMode.Y || Source.ZoomMode == ZoomMode.XY)) ||
                                                    (axis.Orientation.Equals(Orientation.Vertical) && (Source.ZoomMode == ZoomMode.X || Source.ZoomMode == ZoomMode.XY)))
                        {
                            canZoom = true;
                        }
                    }
                    ...
                    {
                        if ((axis.Orientation.Equals(Orientation.Vertical) && (Source.ZoomMode == ZoomMode.Y || Source.ZoomMode == ZoomMode.XY)) ||
                            (axis.Orientation.Equals(Orientation.Horizontal) && (Source.ZoomMode == ZoomMode.X || Source.ZoomMode == ZoomMode.XY)))
                        {
                            canZoom = true;
                        }
                    }
    ...
    /// </summary>
    internal class ZoomOut : ZoomingToolBarItem
    {
        #region Constructor
        ...
        public ZoomOut()
        {
            ...
            Tag = "ZoomOut";
            ToolTipService.SetToolTip(this, ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("ZoomOut"));
        }
...
#region Methods
    ...
    /// </summary>
    internal class ZoomReset : ZoomingToolBarItem
    {
#region Constructor
        ...
        public ZoomReset()
        {
            ...
            Tag = "Reset";
            ToolTipService.SetToolTip(this, ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("Reset"));
        }
...
#region Protected Methods
    ...
    /// </summary>
    internal class ZoomPan : ZoomingToolBarItem
    {
        #region Constructor
        ...
        public ZoomPan()
        {
            ...
            Tag = "Panning";
            ToolTipService.SetToolTip(this, ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("Pan"));
        }
...
#region Protected Methods
        ...
        protected override void OnPointerPressed(PointerRoutedEventArgs e)
        {
            if (Source.IsActive)
            {
                ...
                foreach (ZoomingToolBarItem item in Source.ChartZoomingToolBar.Items)
                {
                    if (item is ZoomPan)
                    {
    ...
    /// </summary>
    internal class SelectionZoom : ZoomingToolBarItem
    {
        #region Constructor
        ...
        public SelectionZoom()
        {
            ...
            Tag = "Selection";
            ToolTipService.SetToolTip(this, ChartLocalizationResourceAccessor.Instance.GetLocalizedStringResource("BoxSelectionZoom"));
        }
