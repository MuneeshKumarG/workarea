...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class SfChartResizableBar : ResizableScrollBar
    {
...
#region Fields
        ...
        private bool onButtonPressed, isValueChanged;
...
#region Private Methods
        ...
        private void RaiseZoomChangingEvent(double newPosition, double newFactor)
        {
            if (axis.Area != null)
            {
                ...
                (axis.Area as ChartBase).OnZoomChanging(zoomChangingEventArgs);
            }
        }
        ...
        private void RaiseZoomChangedEvent(double prevPosition, double prevFactor)
        {
            if (axis.Area != null)
            {
                ...
                (axis.Area as ChartBase).OnZoomChanged(zoomChangedEventArgs);
            }
        }
        ...
        private void RaisePanChangedevent(double zoomPosition)
        {
            if (axis.Area != null)
            {
                ...
                (axis.Area as ChartBase).OnPanChanged(panChangedEventArgs);
            }
        }
        ...
        private void RaisePanChangingEvent(double prevPosition, double newPosition)
        {
            if (axis.Area != null)
            {
                ...
                (axis.Area as ChartBase).OnPanChanging(panChangingEventArgs);
            }
        }
