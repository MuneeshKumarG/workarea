...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// </code>
    /// </example>
    /// <seealso cref="StackingSeriesBase" />
    /// <seealso cref="Syncfusion.UI.Xaml.Charts.ISegmentSpacing" />
    /// <seealso cref="Syncfusion.UI.Xaml.Charts.ISegmentSelectable" />
    internal class FastStackingColumnBitmapSeries : StackingSeriesBase, ISegmentSpacing, ISegmentSelectable

    {
                ...
                if (xValues != null)
                {
                    ...
                    if (isGrouped)
                    {
                        ...
                        if (Segment == null || Segments.Count == 0)
                        {
                            ...
                            {
                                Segment = CreateSegment() as FastStackingColumnSegment;
                                if (Segment != null)
                                {
                                    Segment.Item = ActualData;
                                }
        ...
        internal override Point GetDataPointPosition(ChartTooltip tooltip)
        {
            ...
            Point point = ChartTransformer.TransformToVisible(chartPointinfo.XData, YRangeEndValues[chartPointinfo.Index]);
        ...
        protected override ChartSegment CreateSegment()
        {
            if (this.IsActualTransposed)
                ...
                return new FastStackingColumnSegment();
        }
