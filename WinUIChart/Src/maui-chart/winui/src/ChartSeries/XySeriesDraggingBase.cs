...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public abstract class XySeriesDraggingBase : XySegmentDraggingBase
    {
        ...
        private void UpdatePreviewIndicatorPosition(Point mousePos)
        {
            if (PreviewSeries == null && DraggingSegment == null && EnableSegmentDragging)
            {
                ...
                else if (AdornmentsInfo != null && AdornmentsInfo.MarkerType != ChartSymbol.Custom)
                {
                    AddAnimationEllipse(
    ...
    internal class XySeriesDragEventArgs : DragDelta
    {
        #region Properties
    ...
    internal class ChartDragSeriesInfo : ChartDragPointinfo
    {
        #region Fields
    ...
    internal class XySegmentEnterEventArgs : EventArgs
    {
        #region Properites
