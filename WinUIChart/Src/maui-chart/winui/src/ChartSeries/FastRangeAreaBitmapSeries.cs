...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class FastRangeAreaBitmapSeries : RangeSeriesBase, ISegmentSelectable
    {
            ...
            if (xValues != null)
            {
                ...
                if (!isGrouping)
                {
                    ...
                    if (double.IsNaN(GroupedSeriesYValues[1][0]) || !double.IsNaN(GroupedSeriesYValues[0][0]))
                    {
                        ...
                        AddSegment(segPoints, false, GroupedSeriesYValues[0][0], GroupedSeriesYValues[1][0], ActualData[0]);
                    }
                    ...
                    for (i = 0; i < xValues.Count - 1; i++)
                    {
                        if (!double.IsNaN(GroupedSeriesYValues[1][i]) && !double.IsNaN(GroupedSeriesYValues[0][i]))
                        {
                            ...
                            if (!double.IsNaN(GroupedSeriesYValues[1][i + 1]) && !double.IsNaN(GroupedSeriesYValues[0][i + 1]))
                            {
                                ...
                                if (crossPoint != null)
                                {
                                    ...
                                    AddSegment(segPoints, (GroupedSeriesYValues[1][i] > GroupedSeriesYValues[0][i]), GroupedSeriesYValues[0][i], GroupedSeriesYValues[1][i], ActualData[i]);
                                    segPoints = new List<ChartPoint>();
                                    segPoints.Add(crossPointValue);
                                    segPoints.Add(crossPointValue);
                                }
                        ...
                        else
                        {
                            if (segPoints.Count > 0)
                            {
                                if (!double.IsNaN(GroupedSeriesYValues[1][i - 1]) && !double.IsNaN(GroupedSeriesYValues[0][i - 1]))
                                {
                                    AddSegment(segPoints, false, GroupedSeriesYValues[0][i - 1], GroupedSeriesYValues[1][i - 1], ActualData[i - 1]);
                                }
                            }
                    ...
                    else if (i == xValues.Count - 1 && (double.IsNaN(GroupedSeriesYValues[1][i]) || double.IsNaN(GroupedSeriesYValues[0][i])))
                    {
                        ...
                        AddSegment(segPoints, false, GroupedSeriesYValues[0][i], GroupedSeriesYValues[1][i], ActualData[i]);
                    }
                ...
                else
                {
                    ...
                    if (xValues != null)
                    {
                        if (double.IsNaN(LowValues[0]) || double.IsNaN(HighValues[0]))
                        {
                            ...
                            AddSegment(segPoints, false, HighValues[0], LowValues[0], ActualData[0]);
                        }
                        ...
                        for (i = 0; i < DataCount - 1; i++)
                        {
                            if (!double.IsNaN(LowValues[i]) && !double.IsNaN(HighValues[i]))
                            {
                                ...
                                if (!double.IsNaN(LowValues[i + 1]) && !double.IsNaN(HighValues[i + 1]))
                                {
                                    ...
                                    if (crossPoint != null)
                                    {
                                        ...
                                        AddSegment(segPoints, (LowValues[i] > HighValues[i]), HighValues[i], LowValues[i], ActualData[i]);
                            ...
                            else
                            {
                                if (segPoints.Count > 0)
                                {
                                    if (!double.IsNaN(LowValues[i - 1]) && !double.IsNaN(HighValues[i - 1]))
                                    {
                                        AddSegment(segPoints, false, HighValues[i - 1], LowValues[i - 1], ActualData[i - 1]);
                                    }
                                }
                        ...
                        else if (i == DataCount - 1 && (double.IsNaN(LowValues[i]) || double.IsNaN(HighValues[i])))
                        {
                            ...
                            AddSegment(segPoints, false, HighValues[i], LowValues[i], ActualData[i]);
                        }
                    }
...
#region Internal Override Methods
        ...
        /// <summary>
        /// This method used to get the chart data index at an <see cref="ChartBase"/> co-ordinates
        /// </summary>
        ...
        internal override Point GetDataPointPosition(ChartTooltip tooltip)
        {
            ...
            if (Area.SeriesClipRect.Contains(mousePos))
            {
                ...
                Point point = ChartTransformer.TransformToVisible(xVal, yVal); 
                ...
                case NotifyCollectionChangedAction.Add:
                    ...
                    if (e.NewItems != null && ActualArea.SelectionBehaviour.EnableMultiSelection)
                    {
                        ...
                        if (newIndex >= 0 && ActualArea.GetEnableSegmentSelection())
                        {
                            ...
                            if (dataPoint != null && SelectionBrush != null)
                            {
                                ...
                                OnBitmapSelection(selectedSegmentPixels, SelectionBrush, true);
                            }
        ...
        {
            return new FastRangeAreaSegment();
        }
...
#region Private Methods
        ...
        /// </summary>
        private void AddSegment( List<ChartPoint> segPoints, bool isHighLow, double highValue, double lowValue, object actualData)
        {
            var segment = CreateSegment() as FastRangeAreaSegment;
            if (segment != null)
            {
                segment.Series = this;
