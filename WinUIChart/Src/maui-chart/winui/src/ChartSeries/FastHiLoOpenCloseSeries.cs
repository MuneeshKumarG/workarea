...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class FastHiLoOpenCloseBitmapSeries : FinancialSeriesBase, ISegmentSpacing, ISegmentSelectable
    {
        ...
        public override void CreateSegments()
        {
            ...
            if (xValues != null)
            {
                if (isGrouped)
                {
                    ...
                    {
                        FastHiLoOpenCloseSegment segment = CreateSegment() as FastHiLoOpenCloseSegment;
                        if (segment != null)
                        {
                            segment.Series = this;
        ...
        {
            return new FastHiLoOpenCloseSegment();
        }
