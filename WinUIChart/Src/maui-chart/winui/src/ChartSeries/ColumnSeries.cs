...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class ColumnSeries : XySegmentDraggingBase, ISegmentSelectable, ISegmentSpacing
    {
        ...
        public static readonly DependencyProperty SelectionBrushProperty =
            DependencyProperty.Register(nameof(SelectionBrush), typeof(Brush), typeof(ColumnSeries),
        ...
        public static readonly DependencyProperty SelectedIndexProperty =
            DependencyProperty.Register(nameof(SelectedIndex), typeof(int), typeof(ColumnSeries),
            ...
            try
            {
                ...
                else
                {
                    if (!this.IsActualTransposed)
                    {
                        ...
                        if (currPos > Area.ActualValueToPoint(ActualYAxis, ActualXAxis.Origin))
                        {
