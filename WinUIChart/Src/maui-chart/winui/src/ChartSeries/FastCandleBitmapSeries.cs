...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class FastCandleBitmapSeries : FinancialSeriesBase, ISegmentSpacing, ISegmentSelectable
    {
        ...
        public static readonly DependencyProperty SelectionBrushProperty =
            DependencyProperty.Register(nameof(SelectionBrush), typeof(Brush), typeof(FastCandleBitmapSeries),
        ...
        public override void CreateSegments()
        {
            ...
            if (xValues != null)
            {
                if (isGrouped)
                {
                    ...
                    {
                        Segment = CreateSegment() as FastCandleBitmapSegment;
                        if (Segment != null)
                        {
                            Segment.Series = this;
        ...
        internal override Point GetDataPointPosition(ChartTooltip tooltip)
        {
            ...
            Point point = ChartTransformer.TransformToVisible(chartPointinfo.XData, chartPointinfo.High);
...
#region Protected Internal Override Methods
        ...
        {
            return new FastCandleBitmapSegment();
        }
        ...
        private void OnBitmapHollowSelection(List<int> SegmentPixels, List<int> BorderPixels)
        {
            if (SegmentPixels != null && SegmentPixels.Count > 0)
            {
...

                {
                    ...
                    int j = 0;
                    NativeColor SegmentColor = Colors.Transparent;
                    NativeColor BorderColor = ((Segments[0] as FastCandleBitmapSegment).GetSegmentBrush(dataPoint.Index));
