...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class HiLoOpenCloseSeries : FinancialSeriesBase, ISegmentSpacing, ISegmentSelectable
    {
...
#region Public Override Methods
            ...
            if (xValues != null)
            {
                ...
                if (!isGrouping)
                {
                    ...
                    for (int i = 0; i < xValues.Count; i++)
                    {
                        ...
                        HiLoOpenCloseSegment hiloOpenClose = CreateSegment() as HiLoOpenCloseSegment;
                        if (hiloOpenClose != null)
                        {
                            hiloOpenClose.Series = this;
        ...
        {
            HiLoOpenCloseSegment hiLoOpenCloseSegment = ToolTipTag as HiLoOpenCloseSegment;
            Point newPosition = new Point();
            Point point = ChartTransformer.TransformToVisible(hiLoOpenCloseSegment.XRange.Median, hiLoOpenCloseSegment.YRange.End);
