...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class FastHiLoBitmapSeries : RangeSeriesBase, ISegmentSelectable
    {
#region Dependency Property Registration
        ...
        public static readonly DependencyProperty SelectionBrushProperty =
            DependencyProperty.Register(nameof(SelectionBrush), typeof(Brush), typeof(FastHiLoBitmapSeries),
        ...
        public override void CreateSegments()
        {
            ...
            if (xValues != null)
            {
                if (isGrouped)
                {
                    ...
                    {
                        FastHiLoSegment segment = CreateSegment() as FastHiLoSegment;
                        if (segment != null)
                        {
                            segment.Series = this;
                    ...
                    for (int i = 0; i < xValues.Count; i++)
                    {
                        ...
                        {
                            xValues[i] += center;
                            if (AdornmentsInfo != null && ShowDataLabels && GroupedSeriesYValues[0].Count > i)
