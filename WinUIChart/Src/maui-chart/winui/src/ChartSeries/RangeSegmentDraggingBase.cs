...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// </summary>
    internal abstract class RangeSegmentDraggingBase : RangeSeriesBase
    {
        ...
        protected virtual void UpdateDragSpliterHigh(Rectangle rect)
        {
            ...
            if (IsActualTransposed)
            {
                ...
                DragSpliterHigh.Margin = new Thickness().GetThickness(0, margin, 0, margin);
            ...
            else
            {
                ...
                DragSpliterHigh.Margin = new Thickness().GetThickness(margin, 0, margin, 0);
        ...
        protected virtual void UpdateDragSpliterLow(Rectangle rect)
        {
            ...
            if (IsActualTransposed)
            {
                ...
                margin = height / 3;
                spliterHeight = height - margin * 2;
                DragSpliterLow.Margin = new Thickness().GetThickness(0, margin, 0, margin);
            ...
            else
            {
                ...
                margin = width / 3;
                spliterWidth = width - margin * 2;
                DragSpliterLow.Margin = new Thickness().GetThickness(margin, 0, margin, 0);
                canvasLeft = Canvas.GetLeft(rect);
                canvasTop = bottom - 7;
                spliterHeight = spliterWidth / 5;
            }
...
#region Private Methods
    ...
    internal class RangeDragEventArgs : RangeDragEndEventArgs
    {
#region Properties
...
#region Public Properties
    ...
    internal class RangeDragEndEventArgs : EventArgs
    {
#region Properties
...
#region Public Properties
    ...
    internal class RangeSegmentEnterEventArgs : EventArgs
    {
#region Properties
