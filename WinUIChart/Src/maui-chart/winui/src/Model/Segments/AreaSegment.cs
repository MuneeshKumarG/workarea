    ...
    public class AreaSegment : ChartSegment
    {
        ...
        public override void Update(IChartTransformer transformer)
        {
            ...
            if (transformer != null)
            {
                ...
                if (Series.ActualXAxis != null && Series.ActualXAxis.Origin == 0
                    && Series.ActualYAxis is LogarithmicAxis && (Series.ActualYAxis as LogarithmicAxis).Minimum != null)
                    origin = (double)(Series.ActualYAxis as LogarithmicAxis).Minimum;
