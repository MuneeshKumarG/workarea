    ...
    public class FastBarBitmapSegment : ChartSegment
    {
        ...
        public override void Update(IChartTransformer transformer)
        {
            ...
            if (transformer != null && Series.DataCount != 0)
            {
                ...
                left = (Series as ChartSeries).Area.SeriesClipRect.Right - cartesianTransformer.YAxis.RenderedRect.Right;
                top = (Series as ChartSeries).Area.SeriesClipRect.Bottom - cartesianTransformer.XAxis.RenderedRect.Bottom;
        ...
        internal void UpdateVisual()
        {
            ...
            NativeColor color;
            ChartBase chart = fastBarSeries.Area;
            ...
            {
                Brush segmentSelectionBrush = (fastBarSeries as ISegmentSelectable).SelectionBrush;
            ...
            if (bitmap != null && x1Values.Count != 0)
            {
                ...
                for (int i = 0; i < dataCount; i++)
                {
                    ...
                    else if (fastBarSeries.SelectedSegmentsIndexes.Contains(startIndex) && (fastBarSeries as ISegmentSelectable).SelectionBrush != null)
                    {
