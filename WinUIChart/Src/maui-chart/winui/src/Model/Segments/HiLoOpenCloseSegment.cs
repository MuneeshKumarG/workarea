...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class HiLoOpenCloseSegment : ChartSegment
    {
#region Fields
...
#region Public Properties
        ...
        public Brush ActualInterior
        {
            get
            {
                ...
                else if ((Series as ISegmentSelectable).SelectionBrush != null && IsSegmentSelected())
                    return (Series as ISegmentSelectable).SelectionBrush;
                else
