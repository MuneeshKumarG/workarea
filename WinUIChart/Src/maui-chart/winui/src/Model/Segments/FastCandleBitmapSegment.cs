...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class FastCandleBitmapSegment : ChartSegment
    {
        #region Fields
        ...
        {
            sbsInfo = Series.GetSideBySideInfo(Series);
        ...
        {
            var fastCandleBitmapSeries = Series as ChartSeries;
        ...
        {
            var fastCandleBitmapSeries = Series as ChartSeries;
            NativeColor color = new NativeColor();
            if (bitmap != null && xValues.Count != 0)
            {
                ...
                {
                    ChartBase chart = fastCandleBitmapSeries.Area;
                    ...
                    {
                        Brush segmentSelectionBrush = (fastCandleBitmapSeries as ISegmentSelectable).SelectionBrush;
        ...
        /// <returns></returns>
        internal NativeColor GetSegmentBrush(int index)
        {
            var fastCandleBitmapSeries = Series as ChartSeries;
            NativeColor color;
        ...
        private void CalculatePoints(ChartTransform.ChartCartesianTransformer cartesianTransformer)
        {
            ...
            if (Series.IsIndexed)
            {
                bool isGrouping = (Series.ActualXAxis is CategoryAxis) &&
        ...
        private void UpdateVisualVertical(int width, int height, NativeColor color, int leftThickness, int rightThickness)
        {
            var fastCandleBitmapSeries = Series as ChartSeries;
            ...
            for (int i = 0; i < dataCount; i++)
            {
                ...
                else if (fastCandleBitmapSeries.SelectedSegmentsIndexes.Contains(startIndex) && (fastCandleBitmapSeries as ISegmentSelectable).SelectionBrush != null)
        ...
        private void UpdateVisualHorizontal(int width, int height, NativeColor color, int leftThickness, int rightThickness)
        {
            var fastCandleBitmapSeries = Series as ChartSeries;
