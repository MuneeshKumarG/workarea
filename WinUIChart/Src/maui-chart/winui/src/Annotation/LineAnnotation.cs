...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal class LineAnnotation : ShapeAnnotation
    {
        ...
        {
            get { return (LineCap)GetValue(LineCapProperty); }
        ...
        internal void AddThumb()
        {
            ...
            nearThumb.Margin = new Thickness().GetThickness(-10, -10, -10, -10);
            farThumb.Margin = new Thickness().GetThickness(-10, -10, -10, -10);
        ...
        protected override Point GetTextPosition(Size desiredSize, Point originalPosition, Size textSize)
        {
            ...
            {
                point = CalculateHorizontalPosition(desiredSize, point, textSize);
            }
            else
            {
                point = CalculateVerticalPosition(desiredSize, point, textSize);
            }
        ...
        private Point CalculateHorizontalPosition(Size desiredSize, Point point, Size textSize)
        {
            ...
            switch (verticalAlignment)
            {
                ...
                case VerticalAlignment.Bottom:
                    ...
                    TextElement.Margin = new Thickness().GetThickness(0, minimumSize, 0, 0);
                    break;
                case VerticalAlignment.Top:
                    point.Y += (desiredSize.Height / 2);
                    point.Y -= (textSize.Height);
                    TextElement.Margin = new Thickness().GetThickness(0, 0, 0, minimumSize);
                    break;
            }
            return point;
        }
...
#region Private Methods
        ...
        private void OnFarThumbDragDelta(object sender, DragDeltaEventArgs e)
        {
            ...
            if (!isRotated)
            {
                if (IsHorizontal)
                {
                    x1 = IsAxis ? ChartBase.PointToAnnotationValue(XAxis, new Point(ActualX1 + HorizontalChange, 0)) : ActualX1 + HorizontalChange;
                ...
                if (IsVertical)
                {
                    y1 = IsAxis ? ChartBase.PointToAnnotationValue(YAxis, new Point(0, ActualY1 + VerticalChange)) : ActualY1 + VerticalChange;
            ...
            else
            {
                if (IsVertical)
                {
                    x1 = IsAxis ? ChartBase.PointToAnnotationValue(XAxis, new Point(0, ActualX1 + HorizontalChange)) : ActualX1 + HorizontalChange;
                ...
                if (IsHorizontal)
                {
                    y1 = IsAxis ? ChartBase.PointToAnnotationValue(YAxis, new Point(ActualY1 + VerticalChange, 0)) : ActualY1 + VerticalChange;
        ...
        private void OnNearThumbDragDelta(object sender, DragDeltaEventArgs e)
        {
            ...
            if (!isRotated)
            {
                if (IsHorizontal)
                {
                    x2 = IsAxis ? ChartBase.PointToAnnotationValue(XAxis, new Point(ActualX2 + HorizontalChange, 0)) : ActualX2 + HorizontalChange;
                ...
                if (IsVertical)
                {
                    y2 = IsAxis ? ChartBase.PointToAnnotationValue(YAxis, new Point(0, ActualY2 + VerticalChange)) : ActualY2 + VerticalChange;
            ...
            else
            {
                if (IsVertical)
                {
                    x2 = IsAxis ? ChartBase.PointToAnnotationValue(XAxis, new Point(0, ActualX2 + HorizontalChange)) : ActualX2 + HorizontalChange;
                ...
                if (IsHorizontal)
                {
                    y2 = IsAxis ? ChartBase.PointToAnnotationValue(YAxis, new Point(ActualY2 + VerticalChange, 0)) : ActualY2 + VerticalChange;
