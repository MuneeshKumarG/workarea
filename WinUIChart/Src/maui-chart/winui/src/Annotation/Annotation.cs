...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// <summary>
    /// Provides a lightweight control for displaying overlay element in <see cref="ChartBase"/>.
    /// </summary>
    /// <seealso cref="FrameworkElement" />
    internal abstract class Annotation : FrameworkElement
    {
...
#region Constructor
        ...
        public Annotation()
        {
            ...
            Foreground = new SolidColorBrush(Color.FromArgb(255, 68, 68, 68));
        }
...
#region Public Properties
        ...
        /// </summary>
        /// <value>
        /// This accepts all the <see cref="FontFamily"/>.
        /// </value>
...
#region Internal Properties
        ...
        /// </summary>
        internal virtual ChartBase Chart
        {
            get
            {
                return chart;
...
#region Internal Methods
        ...
        internal void SetAxisFromName()
        {
            if (Chart != null)
            {
                this.XAxis = Chart.InternalAxes[this.XAxisName] ?? Chart.InternalPrimaryAxis;
                this.YAxis = Chart.InternalAxes[this.YAxisName] ?? Chart.InternalSecondaryAxis;
            }
        }
...
#region Protected Methods
        ...
        /// <summary>
        /// Checks whether the given two <see cref="Rect"/> intersects.
        /// </summary>
        /// <param name="r1">The first <see cref="Rect"/></param>
        /// <param name="r2">The second <see cref="Rect"/></param>
...
#else
            transformation = MatrixHelper.FromElements(cos, sin, -sin, cos, 0, 0);
#endif
...
#else
            matrix.Matrix = MatrixHelper.FromElements(cos, sin, -sin, cos, 0, (transformedDesiredElement.Height / 2) - offsety);
#endif
...
#elif WinUI_UWP
            return MatrixHelper.Transform(matrix.Matrix, originalPoint);
#else
...
#else
            Point leftTop = MatrixHelper.Transform(matrix, new Point(rect.Left, rect.Top));
            Point rightTop = MatrixHelper.Transform(matrix, new Point(rect.Right, rect.Top));
            Point leftBottom = MatrixHelper.Transform(matrix, new Point(rect.Left, rect.Bottom));
            Point rightBottom = MatrixHelper.Transform(matrix, new Point(rect.Right, rect.Bottom));
#endif
...
#region Private Methods
    ...
    /// </summary>
    internal class AnnotationDragDeltaEventArgs : EventArgs
    {
        /// <summary>
    ...
    /// </summary>
    internal class AnnotationDragCompletedEventArgs : EventArgs
    {
        /// <summary>
        /// Gets or sets the new <see cref="Position"/>
        /// </summary>
