...
{
    internal abstract class ShapeAnnotation : SingleAnnotation
    {
        ...
        /// </summary>
        public static new readonly DependencyProperty CanDragProperty =
            DependencyProperty.Register(
                "CanDrag",
                typeof(bool),
                typeof(ShapeAnnotation),
        ...
        {
            Fill = new SolidColorBrush(Color.FromArgb(50, 22, 178, 199));
            Stroke = new SolidColorBrush(Color.FromArgb(255, 68, 68, 68));
        }
        ...
        /// </summary>
        /// <value>
        /// The <see cref="VerticalAlignment"/> property.
        /// </value>
