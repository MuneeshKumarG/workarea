...
{
    internal abstract class StraightLineAnnotation : LineAnnotation
    {
        ...
        /// </summary>
        internal static readonly DependencyProperty LabelPositionProperty =
            DependencyProperty.Register(
                "LabelPosition",
                typeof(AxisElementPosition),
                typeof(StraightLineAnnotation),
                new PropertyMetadata(AxisElementPosition.Outside, OnAxisLabelPositionChanged));
        ...
        internal static readonly DependencyProperty AxisLabelAlignmentProperty =
            DependencyProperty.Register(
                ...
                typeof(StraightLineAnnotation),
                new PropertyMetadata(LabelAlignment.Center, OnAxisLabelPositionChanged));
        ...
        internal override ChartBase Chart
        {
            get
            {
                return chart;
        ...
        private static void OnAxisLabelPositionChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
