...
namespace Syncfusion.Maui.Core
{
	...
	public class SfEffectsView : SfContentsLayout, ITouchListener, ITapGestureListener, ILongPressGestureListener
	{
		#region Fields
		...
		/// </value>
		public static readonly BindableProperty ContentProperty = BindableProperty.Create(nameof(Content), typeof(View), typeof(SfEffectsView), null, BindingMode.Default, null, OnContentChanged);
		...
		/// <summary>
		/// Gets or sets a value that indicates whether or not the ripple color should fade out as it grows.
		/// </summary>
		/// <value>
