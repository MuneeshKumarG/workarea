...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// </summary>
    internal class ChartPolarAxisLayoutPanel : ILayoutCalculator
    {
        #region Fields
        ...
        /// </summary>      
        public ChartAxis CartesianAxis
        {
            get;
            set;
        }
        ...
        public void DetachElements()
        {
            if (CartesianAxis != null)
            {
                if (CartesianAxis.MajorGridLinesPanel != null)
                    CartesianAxis.MajorGridLinesPanel.Clear();
                if (CartesianAxis.MinorGridLinesPanel != null)
                    CartesianAxis.MinorGridLinesPanel.Clear();
            }
        ...
        public void UpdateElements()
        {
            if (this.Area != null && this.Area.InternalPrimaryAxis != null)
            {
                ...
                PolarAxis = this.Area.InternalPrimaryAxis;
                PolarAxis.AxisLayoutPanel = this;
                var angle = this.Area.InternalSecondaryAxis.PolarAngle;
                ...
                {                                                                    //of secondary axis has changed
                    this.Area.InternalSecondaryAxis.IsVertical = false;
                    ...
                    this.Area.InternalSecondaryAxis.IsVertical = true;
                ...
                CartesianAxis = this.Area.InternalSecondaryAxis;
                foreach (UIElement element in Children)
                {
                    ChartAxis chartAxis = element as ChartAxis;
                    if (chartAxis != null && !Area.InternalAxes.Contains(chartAxis))
        ...
        private void CalculateSeriesRect(Size availableSize)
        {
            ...
            this.Area.AxisThickness = new Thickness().GetThickness(width, height, width, height);
            ...
            Area.PlotArea.Clip = new RectangleGeometry()
            {
