        ...
        internal void Update(Size finalSize)
        {
            ...
            if (canUpdate)
            {
                ...
                if (Series is CircularSeries)
                {
                    ...
                    //Adding and positioning the center view.
                    if (series is DoughnutSeries)
                    {
                        var doughnut = series as DoughnutSeries;
                        var centerView = doughnut.CenterView;
                        if (!this.Children.Contains(centerView))
                        {
                            doughnut.AddCenterView(centerView);
                        }

                        doughnut.PositioningCenterView();
                    }
                }
