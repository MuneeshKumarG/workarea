...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    internal static class ChartMath
    {
        ...
        {
            var div = x2 == x1 ? 1 : x2 - x1;
            double y = (((y2 - y1) / div) * (x - x1)) + y1;
            return y;
        }
        ...
        internal static double ParseAtInvarientCulture(double value)
        {
            ...
            return double.TryParse(value.ToString(CultureInfo.InvariantCulture), out convertedValue) ? convertedValue : value;   
        }
